...
<td><button type=button onclick='changestatus("/editstatus?appid=%s");'>status</button></td><td><button type=button onclick='changemarks("/editmarks?appid=%s");'>Editmark</button></td></tr>"""
...
class Search(webapp.RequestHandler):
		...
		def post(self):
			...
			for app in apps:
				...
				app.qpmark,app.qpmaxmark,app.qcmark,app.qcmaxmark,app.qmmark,app.qmmaxmark,app.epcmark,app.epcmaxmark,app.emmark,app.emmaxmark,app.resphone,app.appid,app.appid)
